...
static const float RED_CHANNEL_COUNTS_TO_IRRADIANCE = 5.029463048797554f;
static const float GREEN_CHANNEL_COUNTS_TO_IRRADIANCE = 3.7457813075657023f;
static const float BLUE_CHANNEL_COUNTS_TO_IRRADIANCE = 3.3125875108148857f;
