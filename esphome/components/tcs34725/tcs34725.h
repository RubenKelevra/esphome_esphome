...
class TCS34725Component : public PollingComponent, public i2c::I2CDevice {
 public:
  ...
  void set_red_irradiance_sensor(sensor::Sensor *red_irradiance_sensor) { red_irradiance_sensor_ = red_irradiance_sensor; }
  void set_green_irradiance_sensor(sensor::Sensor *green_irradiance_sensor) { green_irradiance_sensor_ = green_irradiance_sensor; }
  void set_blue_irradiance_sensor(sensor::Sensor *blue_irradiance_sensor) { blue_irradiance_sensor_ = blue_irradiance_sensor; }
